...
p_Christchurch_Admissions_terror  = 
  brms::hypothesis(brm_Christchurch_Admissions, 'effectterror > 0')$hypothesis$Post.Prob
p_Christchurch_Reperfusion_terror  = 
  brms::hypothesis(brm_Christchurch_Reperfusion, 'effectterror > 0')$hypothesis$Post.Prob
p_Christchurch_LVO_terror  = 
  brms::hypothesis(brm_Christchurch_LVO, 'effectterror > 0')$hypothesis$Post.Prob
p_Christchurch_Thrombectomy_terror  = 
  brms::hypothesis(brm_Christchurch_Thrombectomy, 'effectterror > 0')$hypothesis$Post.Prob
p_Christchurch_Thrombolysis_terror  = 
  brms::hypothesis(brm_Christchurch_Thrombolysis, 'effectterror > 0')$hypothesis$Post.Prob
